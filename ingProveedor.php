...
<head>
   ...
   <link rel="icon" href="img/favicon.ico" type="image/x-icon" />    
    ...
    <script>  
        ...
        {
         swal({type:'warning', title:'El Proveedor Ya Existe...',  text:'ADVERTENCIA', showConfirmButton: true, confirmButtonColor: "orange", confirmButtonText:'Aceptar', timer: 1000},
         function(){
            location.href = 'ingProveedor.php?usuario='+'<?php echo base64_encode($usuario); ?>';
         });     
        }   
...
//---------------------------------------------------------------------------------------------------------------------------    
    ...
    if(isset($_POST['proveedor'])){
        ...
        $sqlMax ="SELECT NVL(MAX(COD_PROVEEDOR),0)+1 correlativo
        ...
        $cadena = "" . $correlativo . ",'" .$nom_proveedor . "','" . $nit_proveedor . "'";               
               
        $sqlInserta = "INSERT INTO TB_PAGA_CAT_PROVEEDOR
                       VALUES($cadena)";
    ...
    <br /><br /><br />
        ...
        <header class="container__header">
            <div class="wrapper__logo--interno registro--logo">
                ...
                <h1 class="titulo--interno">Agregar Proveedor</h1>
        ...
        <div class="container">                    
            ...
            <div class="card">
                ...
                <div class="card-header"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-list fa-stack-1x fa-inverse"></i></span><strong>Proveedores</strong></div>
                    ...
                    <form name="frmingreso" id="frmingreso" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">                           
                     ...
                     <input type="hidden" class="form-control" name="usuario" id="usuario" value="<?php echo $usuario; ?>" readonly=""/>
                        ...
                        <div class="form-group">        	            
                            <input type="text" class="form-control" name="nit_proveedor" id="nit_proveedor" placeholder="Ingrese NIT de Proveedor" maxlength="25" onkeypress="return soloNit(event);" onkeyup="javascript:this.value=this.value.toUpperCase();" autofocus="" required="required" />
                        </div>
                        
                        <span>Nombre de Proveedor: </span>
		                <div class="form-group">
                            <input type="text" class="form-control" name="nom_proveedor" id="nom_proveedor" placeholder="Ingrese Nombre de Proveedor" maxlength="150" onkeyup="javascript:this.value=this.value.toUpperCase();" required="required" />
                        </div>
                   
                 <!--INICIO BOTON GUARDAR DATOS-->   
                <div>
                    <button type="submit" name="proveedor" value="proveedor" id="proveedor" class="btn btn-success btn-block"><i class="fa fa-save"></i> Guardar Proveedor</button>                    
                </div>    
