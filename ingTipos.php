   ...
   <link rel="icon" href="img/favicon.ico" type="image/x-icon" />    
    ...
    <script>  
        ...
        function alerta_error()
        {
         ...
         function(){
            location.href = 'ingTipos.php?usuario='+'<?php echo base64_encode($usuario); ?>';
         });     
        }   
...
//---------------------------------------------------------------------------------------------------------------------------    
    ...
    if(isset($_POST['tipo'])){
        ...
        $sqlMax ="SELECT NVL(MAX(COD_TIPO),0)+1 correlativo
        ...
        $cadena = "" . $correlativo . ",'" .$nom_tipo. "'";               
               
        $sqlInserta = "INSERT INTO TB_PAGA_CAT_TIPO
                       VALUES($cadena)";
    ...
    <br /><br /><br />
        ...
        <header class="container__header">
            <div class="wrapper__logo--interno registro--logo">
                ...
                <h1 class="titulo--interno">Agregar Tipo</h1>
        ...
        <div class="container">                    
            ...
            <div class="card">
                ...
                <div class="card-header"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-list fa-stack-1x fa-inverse"></i></span><strong>Tipos</strong></div>
                    ...
                    <form name="frmingreso" id="frmingreso" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">                           
                     ...
                     <input type="hidden" class="form-control" name="usuario" id="usuario" value="<?php echo $usuario; ?>" readonly=""/>
		                ...
		                <div class="form-group">
                            <input type="text" class="form-control" name="nom_tipo" id="nom_tipo" placeholder="Ingrese Nombre de Tipo" maxlength="150" onkeyup="javascript:this.value=this.value.toUpperCase();" autofocus="" required="" />
                        </div>
                   
                 <!--INICIO BOTON GUARDAR DATOS-->   
                <div>
                    <button type="submit" name="tipo" value="tipo" id="tipo" class="btn btn-success btn-block"><i class="fa fa-save"></i> Guardar Tipo</button>                    
                </div>    
